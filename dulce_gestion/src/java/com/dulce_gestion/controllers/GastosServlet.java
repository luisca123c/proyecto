...
public class GastosServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (editarId != null) {
            try {
                FilaGasto gastoEditar = new GastosDAO().obtenerPorId(Integer.parseInt(editarId));
    ...
    /**
     * Carga la lista de gastos y los métodos de pago como atributos del request.
    ...
    /**
     * Obtiene el usuario en sesión y verifica que tenga rol de Administrador
     * o SuperAdministrador. Redirige a {@code /login} si no hay sesión activa,
     * o a {@code /dashboard} si el rol es Empleado.
     *
